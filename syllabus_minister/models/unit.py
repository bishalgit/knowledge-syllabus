...
class Unit(models.Model):
    ...
    course_id = fields.Many2one('syllabus_minister.course',string='Course',domain="['|', ('program_id.faculty_id.university_id.university_user_ids', '=', uid), ('group_ids.users.id', '=', uid)]")
